...
public class ChatRecord extends UpdatableRecordImpl<ChatRecord> implements Record3<Long, OffsetDateTime, String> {
    ...
    @Override
    @NotNull
    public ChatRecord values(@NotNull Long value1, @NotNull OffsetDateTime value2, @NotNull String value3) {
        value1(value1);
        value2(value2);
        value3(value3);
        return this;
    ...
    public ChatRecord(@NotNull Long id, @NotNull OffsetDateTime createdAt, @NotNull String createdBy) {
        super(Chat.CHAT);
