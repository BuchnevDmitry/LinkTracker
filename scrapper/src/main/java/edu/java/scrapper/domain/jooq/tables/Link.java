...
public class Link extends TableImpl<LinkRecord> {
    ...
    /**
     * The column <code>LINK.HASH_INT</code>.
     */
    public final TableField<LinkRecord, Long> HASH_INT =
        createField(DSL.name("HASH_INT"), SQLDataType.BIGINT, this, "");
     ...
     */
    public <U> SelectField<U> mapping(Function6<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super String, ? super Long, ? extends U> from) {
    ...
    public <U> SelectField<U> mapping(
        Class<U> toType,
        Function6<? super Long, ? super String, ? super OffsetDateTime, ? super OffsetDateTime, ? super String, ? super Long, ? extends U> from
    ) {
