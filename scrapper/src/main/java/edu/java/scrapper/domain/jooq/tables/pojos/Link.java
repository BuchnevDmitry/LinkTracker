...
public class Link implements Serializable {
     ...
     */
    public void setHashInt(@Nullable Long hashInt) {
        this.hashInt = hashInt;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.hashInt == null) {
            if (other.hashInt != null) {
                return false;
            }
        } else if (!this.hashInt.equals(other.hashInt)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = prime * result + ((this.hashInt == null) ? 0 : this.hashInt.hashCode());
        return result;
    }
